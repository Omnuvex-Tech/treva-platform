...
Application-specific classes (e.g., `ApiResponse`) live in `apps/treva-web/classes/`, not in shared packages. Only truly shared utilities belong in `packages/shared`.
