...
export interface RichTextEditorProps {
    ...
    required?: boolean;
    disabled?: boolean;
    /** Minimum height of the writing area in pixels; it grows with the text. */
    minHeight?: number;
    className?: string;
    /**
            ...
            */}
            <style>{`
                .treva-rte__content {
                    ...
                    /* Qutu mətnlə birlikdə uzanır: nə şaquli, nə üfüqi
                       sürüşmə zolağı — oxucu səhifənin özü ilə sürüşür. */
                    overflow: visible;
                    outline: none;
                    font-size: 14px;
                    line-height: 22px;
