...
import { createDuplicateToken, duplicateCode, duplicateText } from "../../utils/duplicate";
...
export function CurrenciesSection() {
    const {
        ...
        deleteFn: (itemId) => currenciesApi.delete(itemId),
        getItemId: (item: Currency) => item.id,
        getDeleteLabel: (item: Currency) => item.name,
        entityName: "Currency",
        buildDuplicatePayload: (item: Currency) => {
