...
export function SalesOfficeOptionsSection() {
    const {
        items,
        isLoading,
        showForm,
        ...
        mapItemToForm: (item: SalesOfficeOption) => ({
            value: item.value,
        }),
        buildPayload: (nextForm) => ({
            value: nextForm.value,
        }),
        createFn: (payload) => salesOfficeOptionsApi.create(payload),
        updateFn: (itemId, payload) => salesOfficeOptionsApi.update(itemId, payload),
        deleteFn: (itemId) => salesOfficeOptionsApi.delete(itemId),
        getItemId: (item: SalesOfficeOption) => item.id,
        getDeleteLabel: (item: SalesOfficeOption) => item.value,
        entityName: "Sales office",
        buildDuplicatePayload: (item: SalesOfficeOption) => {
    ...
    return (
        <CrudSection
            ...
            items={items}
            emptyText="No sales offices yet"
