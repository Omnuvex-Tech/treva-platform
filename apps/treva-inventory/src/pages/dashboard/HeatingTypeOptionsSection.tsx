...
export function HeatingTypeOptionsSection() {
    const {
        items,
        isLoading,
        showForm,
        ...
        mapItemToForm: (item: HeatingTypeOption) => ({
            name: item.name,
            title: item.title,
        }),
        ...
        createFn: (payload) => heatingTypeOptionsApi.create(payload),
        updateFn: (itemId, payload) => heatingTypeOptionsApi.update(itemId, payload),
        deleteFn: (itemId) => heatingTypeOptionsApi.delete(itemId),
        getItemId: (item: HeatingTypeOption) => item.id,
        getDeleteLabel: (item: HeatingTypeOption) => item.title,
        entityName: "Heating type",
        buildDuplicatePayload: (item: HeatingTypeOption) => {
    ...
    return (
        <CrudSection
            ...
            items={items}
            emptyText="No heating types yet"
