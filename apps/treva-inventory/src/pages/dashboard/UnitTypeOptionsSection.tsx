...
export function UnitTypeOptionsSection() {
    const {
        items,
        isLoading,
        showForm,
        ...
        mapItemToForm: (item: UnitTypeOption) => ({
            name: item.name,
            title: item.title,
        }),
        ...
        createFn: (payload) => unitTypeOptionsApi.create(payload),
        updateFn: (itemId, payload) => unitTypeOptionsApi.update(itemId, payload),
        deleteFn: (itemId) => unitTypeOptionsApi.delete(itemId),
        getItemId: (item: UnitTypeOption) => item.id,
        getDeleteLabel: (item: UnitTypeOption) => item.title,
        entityName: "Unit type",
        buildDuplicatePayload: (item: UnitTypeOption) => {
