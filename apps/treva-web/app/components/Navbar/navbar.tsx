...
const MenuIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#2E3139" viewBox="0 0 256 256" aria-hidden="true">
...
export default function Navbar({ locale }: { locale: string }) {
    ...
    const currentLocale = locale in navDictionary ? (locale as keyof typeof navDictionary) : "az";
