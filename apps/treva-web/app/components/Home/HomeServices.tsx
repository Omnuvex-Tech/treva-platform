...
export const HomeServices = () => {
    ...
    return (
        <section id="services" className="section_services home-services-section" ref={sectionRef}>
            <div className="global-padding home-services-padding padding-section-medium">
                <div className="container-large home-services-container">
                    <div className="services_component home-services-component">
                        <div className="services_wrap home-services-wrap">
                            <div className="services_top-wrap home-services-top-wrap">
                                <div className="home-services-title-wrap is-large-tablet is-az">
                                    <h2 ref={headingRef} className="heading-style-h2-medium home-services-title">
                                        <span className="heading-gap-h1 home-services-title-gap">    </span>AZƏRBAYCANIN BÖYÜK DAŞINMAZ ƏMLAK PLATFORMASI TREVA İLƏ ƏMƏKDAŞLIQ EDİN VƏ İNKİŞAF POTENSİALINIZI TAM AÇIN.
                                    </h2>
                                </div>
                                <div ref={firstChildRef} className="first-child home-services-label">(xidmətlər)</div>
                            </div>
                            <div className="services_bottom-wrap home-services-bottom-wrap">
                                <div ref={ctaWrapRef} className="services_cta-wrap home-services-cta-wrap">
                                    <div className="note_wrap home-services-note-wrap is-medium-wide">
                                        <div className="home-services-note-text">Satış imkanlarınızı genişləndirmək istəyirsiniz?</div>
                                    </div>
                                    <Link data-wf--button--variant="blue" href="brokers#broker-registration" className="button home-services-cta-button w-inline-block">
                                ...
                                <div className="services_block home-services-block">
                                    ...
                                    <div ref={listRef} className="services_list home-services-list">
                                        <Link data-index="1" href="/developers" className="services_item home-services-item home-services-item-sales-marketIng animate-right w-inline-block">
                                            ...
                                            <div className="services_icon home-services-item-icon w-embed">
                                        ...
                                        <Link data-index="2" href="/developers" className="services_item home-services-item home-services-item-crm animate-right w-inline-block">
                                            <div className="services_item-title home-services-item-title-wrap">
                                                <div className="home-services-item-number">(02)</div>
                                                <div className="text-color-blue400 home-services-item-title">CRM və Leadlərin İdarəolunması</div>
                                            </div>
                                            <div className="services_icon home-services-item-icon w-embed">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.1879 5.5V14.4375C17.1879 14.6198 17.1154 14.7947 16.9865 14.9236C16.8576 15.0526 16.6827 15.125 16.5004 15.125C16.318 15.125 16.1432 15.0526 16.0142 14.9236C15.8853 14.7947 15.8129 14.6198 15.8129 14.4375V7.15945L5.98679 16.9864C5.85779 17.1154 5.68282 17.1879 5.50038 17.1879C5.31794 17.1879 5.14298 17.1154 5.01398 16.9864C4.88497 16.8574 4.8125 16.6824 4.8125 16.5C4.8125 16.3176 4.88497 16.1426 5.01398 16.0136L14.8409 6.1875H7.56288C7.38055 6.1875 7.20568 6.11507 7.07675 5.98614C6.94782 5.8572 6.87538 5.68234 6.87538 5.5C6.87538 5.31766 6.94782 5.1428 7.07675 5.01386C7.20568 4.88493 7.38055 4.8125 7.56288 4.8125H16.5004C16.6827 4.8125 16.8576 4.88493 16.9865 5.01386C17.1154 5.1428 17.1879 5.31766 17.1879 5.5Z" fill="#4C525E" />
                                        ...
                                        <Link data-index="3" href="/developers" className="services_item home-services-item home-services-item-broker-network animate-right w-inline-block">
                                            <div className="services_item-title home-services-item-title-wrap">
                                                <div className="home-services-item-number">(03)</div>
                                                <div className="text-color-blue400 home-services-item-title">Broker Şəbəkəsinin Aktivləşdirilməsi</div>
                                            </div>
                                            <div className="services_icon home-services-item-icon w-embed">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.1879 5.5V14.4375C17.1879 14.6198 17.1154 14.7947 16.9865 14.9236C16.8576 15.0526 16.6827 15.125 16.5004 15.125C16.318 15.125 16.1432 15.0526 16.0142 14.9236C15.8853 14.7947 15.8129 14.6198 15.8129 14.4375V7.15945L5.98679 16.9864C5.85779 17.1154 5.68282 17.1879 5.50038 17.1879C5.31794 17.1879 5.14298 17.1154 5.01398 16.9864C4.88497 16.8574 4.8125 16.6824 4.8125 16.5C4.8125 16.3176 4.88497 16.1426 5.01398 16.0136L14.8409 6.1875H7.56288C7.38055 6.1875 7.20568 6.11507 7.07675 5.98614C6.94782 5.8572 6.87538 5.68234 6.87538 5.5C6.87538 5.31766 6.94782 5.1428 7.07675 5.01386C7.20568 4.88493 7.38055 4.8125 7.56288 4.8125H16.5004C16.6827 4.8125 16.8576 4.88493 16.9865 5.01386C17.1154 5.1428 17.1879 5.31766 17.1879 5.5Z" fill="#4C525E" />
                                        ...
                                        <Link data-index="4" href="/developers" className="services_item home-services-item home-services-item-investment animate-right w-inline-block">
                                            <div className="services_item-title home-services-item-title-wrap">
                                                <div className="home-services-item-number">(04)</div>
                                                <div className="text-color-blue400 home-services-item-title">İnvestisiya Konsultasiyası</div>
                                            </div>
                                            <div className="services_icon home-services-item-icon w-embed">
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.1879 5.5V14.4375C17.1879 14.6198 17.1154 14.7947 16.9865 14.9236C16.8576 15.0526 16.6827 15.125 16.5004 15.125C16.318 15.125 16.1432 15.0526 16.0142 14.9236C15.8853 14.7947 15.8129 14.6198 15.8129 14.4375V7.15945L5.98679 16.9864C5.85779 17.1154 5.68282 17.1879 5.50038 17.1879C5.31794 17.1879 5.14298 17.1154 5.01398 16.9864C4.88497 16.8574 4.8125 16.6824 4.8125 16.5C4.8125 16.3176 4.88497 16.1426 5.01398 16.0136L14.8409 6.1875H7.56288C7.38055 6.1875 7.20568 6.11507 7.07675 5.98614C6.94782 5.8572 6.87538 5.68234 6.87538 5.5C6.87538 5.31766 6.94782 5.1428 7.07675 5.01386C7.20568 4.88493 7.38055 4.8125 7.56288 4.8125H16.5004C16.6827 4.8125 16.8576 4.88493 16.9865 5.01386C17.1154 5.1428 17.1879 5.31766 17.1879 5.5Z" fill="#4C525E" />
