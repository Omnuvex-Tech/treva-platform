...
function FooterNavLink({ href, label }: FooterNavLinkProps) {
  return (
    <Link href={href} className="footer_link-wrap w-inline-block">
      <div className="footer_link-content">
        <div className="footer_link-text">{label}</div>
        <div className="footer_link-text">{label}</div>
      </div>
    </Link>
  );
...
function FooterExternalLink({ href, label }: FooterExternalLinkProps) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="footer_link-wrap w-inline-block">
      <div className="footer_link-content">
        <div className="footer_link-text">{label}</div>
        <div className="footer_link-text">{label}</div>
      </div>
