...
> = {
  az: {
    ...
    titleBold: "",
    sectionLabel: "TREVA Real Estate",
    paragraphs: [
  ...
  en: {
    ...
    sectionLabel: "TREVA Real Estate",
    paragraphs: [
      "We are a real estate platform that brings buyers, developers, and brokers together within a unified sales ecosystem. Every asset in our portfolio is selected for its future value and long-term earning potential.",
      "From sales to investment advisory services, we deliver solutions tailored to your goals.",
    ...
    services: [
      {
        ...
        desc: "We effectively present exclusive real estate opportunities and connect properties with the right buyers.",
      },
      {
        title: "CRM and lead management",
        desc: "We systematically manage client relationships and lead pipelines to deliver strong results.",
      },
      {
        title: "Broker network activation",
        desc: "We strengthen broker partnerships, expand market reach, and maximize sales efficiency.",
      },
      {
        title: "Investment advisory",
        desc: "We provide professional advice and strategic market analysis to support the right investment decisions.",
      },
    ],
  },
  ru: {
    ...
    sectionLabel: "TREVA Real Estate",
    paragraphs: [
      "Мы платформа недвижимости, которая объединяет покупателей, девелоперов и брокеров в единой экосистеме продаж. Каждый актив в нашем портфеле отбирается с учетом его будущей стоимости и устойчивого потенциала доходности.",
      "От продаж до инвестиционного консалтинга мы предлагаем решения, адаптированные под ваши цели.",
      "Наша миссия проста: помогать вам принимать уверенные решения и достигать устойчивого роста на динамичном рынке недвижимости Баку.",
    ],
    services: [
      {
        title: "Продажи и маркетинг",
        desc: "Мы эффективно представляем эксклюзивные возможности недвижимости и соединяем объекты с подходящими покупателями.",
      },
      {
        title: "CRM и управление лидами",
        desc: "Мы системно управляем отношениями с клиентами и потоком лидов, добиваясь сильных результатов.",
      },
      {
        title: "Активация брокерской сети",
        desc: "Мы усиливаем сотрудничество с брокерами, расширяем охват рынка и повышаем эффективность продаж.",
      },
      {
        title: "Инвестиционный консалтинг",
        desc: "Мы предоставляем профессиональные консультации и стратегический анализ рынка для правильных инвестиционных решений.",
      },
    ],
  },
};
    ...
    <main className="about-container">
      <PageContainer className="about-page-container">
        ...
        <section className="services-list">
          <div className="services-list__section-label">{content.sectionLabel}</div>
          {content.services.map((service, index) => (
            <div key={index} className="services-list__item">
              <div className="services-list__left-side">
                <div className="services-list__icon-container">{serviceIcons[index]}</div>
