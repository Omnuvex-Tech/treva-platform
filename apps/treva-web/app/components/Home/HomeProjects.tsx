...
export const HomeProjects = () => {
  return (
    <section className="section_projects-prev">
        ...
        <div className="container-large">
          <div className="projects-prev_component">
            ...
            <div className="projects-prev_intro-wrap">
              <div>(portfolio)</div>
              <div className="max-width-56rem is-az">
                ...
                <div role="listitem" className="projects-prev_item img-reveal w-dyn-item">
                  <div className="projects-prev_holder">
                    ...
                    <Link
                      ...
                      className="projects_overlay w-inline-block"
                    >
                      ...
                      <div lang="" className="projects_caption">
                  ...
                  <Link
                    aria-label="go to project"
                    href="/project/panorama-by-elie-saab"
                    className="projects_content-wrap show-landscape w-inline-block"
                  >
                    <div fs-list-field="location" className="heading-style-h3 text-color-blue400">
                      Panorama by Elie Saab
                    </div>
                    <div fs-list-field="location">Sea Breeze</div>
                    <div fs-list-field="status" className="hide">
                      Under Development
                    </div>
                  </Link>
                </div>
            ...
            {/* Call to action */}
            <div className="projects-prev_cta-wrap">
